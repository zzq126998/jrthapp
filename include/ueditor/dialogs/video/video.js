...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        //MP4文件单独配置
        if(hz == "mp4"){
            $G("preview").innerHTML = '<video class="edui-upload-video  vjs-default-skin video-js" controls="" preload="none" width="' + 420  + '" height="' + 280  + '" src="'+conUrl+'" data-setup="{}"><source src="'+conUrl+'" type="video/mp4"/></video>';
        }else{
