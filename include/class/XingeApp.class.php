...
class XingeApp
{
    ...
    {
        if (floor(floatval($this->accessId)) >= 2200000000) {
    ...
    {
        if (floor(floatval($this->accessId)) >= XingeApp::IOS_MIN_ID and $message instanceof MessageIOS)
            return true;
        else if (floor(floatval($this->accessId)) < XingeApp::IOS_MIN_ID and $message instanceof Message)
            return true;
        else
            return false;
    }
