 ...
 * 教育培训配置
 *
 * @version        $Id: educationConfig.php 2019-07-10 上午10:12:36 $
...
checkPurview("educationConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__) . "/../templates/education";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "educationConfig.html";

$action = $action == "" ? "education" : $action;
...
if ($type != "") {
    ...
    if ($type == "site") {
        ...
        $customeducationcoursesCheck = (int)$educationcoursesCheck;
        $customeducationteacherCheck = (int)$educationteacherCheck;
        $customeducationtutorCheck   = (int)$educationtutorCheck;
        $customeducationwordCheck = (int)$educationwordCheck;
        ...
        $custom_educationcourses_atlasMax = (int)$educationcourses_atlasMax;
        $custom_educationteacher_atlasMax = (int)$educationteacher_atlasMax;
        $custom_educationword_atlasMax = (int)$educationword_atlasMax;
    ...
    $customInc .= "\$customeducationcoursesCheck = '" . $customeducationcoursesCheck . "';\r\n";
    $customInc .= "\$customeducationteacherCheck = '" . $customeducationteacherCheck . "';\r\n";
    $customInc .= "\$customeducationtutorCheck = '" . $customeducationtutorCheck . "';\r\n";
    $customInc .= "\$customeducationwordCheck = '" . $customeducationwordCheck . "';\r\n";

    $customInc .= "\$custom_store_atlasMax = " . (int)$custom_store_atlasMax . ";\r\n";
    $customInc .= "\$custom_educationcourses_atlasMax = " . (int)$custom_educationcourses_atlasMax . ";\r\n";
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $jsFile = array(
        ...
        'publicUpload.js',
        'admin/education/educationConfig.js'
    );
    ...
    $huoniaoTag->assign('educationcoursesCheckNum', array('0', '1'));
    $huoniaoTag->assign('educationcoursesCheckNames', array('需要审核', '不需要审核'));
    $huoniaoTag->assign('educationcoursesCheckChecked', (int)$customeducationcoursesCheck);

    //教育教师
    $huoniaoTag->assign('educationteacherCheckNum', array('0', '1'));
    $huoniaoTag->assign('educationteacherCheckNames', array('需要审核', '不需要审核'));
    $huoniaoTag->assign('educationteacherCheckChecked', (int)$customeducationteacherCheck);

    //家教
    $huoniaoTag->assign('educationtutorCheckNum', array('0', '1'));
    $huoniaoTag->assign('educationtutorCheckNames', array('需要审核', '不需要审核'));
    $huoniaoTag->assign('educationtutorCheckChecked', (int)$customeducationtutorCheck);

    //留言
    $huoniaoTag->assign('educationwordCheckNum', array('0', '1'));
    $huoniaoTag->assign('educationwordCheckNames', array('需要审核', '不需要审核'));
    $huoniaoTag->assign('educationwordCheckChecked', (int)$customeducationwordCheck);
    ...
    $huoniaoTag->assign('educationcourses_atlasMax', $custom_educationcourses_atlasMax);
