 ...
 * 管理教育分类
 *
 * @version        $Id: educationType.php 2019-7-11 下午16:40:21 $
...
checkPurview("educationType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/education";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "educationType.html";

$action = "education_type";
...
//删除分类
	...
	foreach ($idsArr as $kk => $id) {
		...
		if($res){
			delPicFile($res[0]['icon'], "delAdv", "education");
		}
	}
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/education/educationType.js'
	);
