 ...
 * 自助建站人才招聘
 *
 * @version        $Id: websiteJob.php 2014-6-25 下午17:54:25 $
...
if($dopost == "getList"){
	...
	if(count($results) > 0){
		...
		if(count($list) > 0){
			echo '{"state": 100, "info": '.json_encode("获取成功").', "pageInfo": {"totalPage": '.$totalPage.', "totalCount": '.$totalCount.'}, "websiteJob": '.json_encode($list).'}';
		}else{
