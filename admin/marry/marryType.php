 ...
 * 管理婚嫁分类
 *
 * @version        $Id: marryType.php 2019-4-1 下午16:40:21 $
...
checkPurview("marryType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/marry";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "marryType.html";
...
//删除分类
	...
	foreach ($idsArr as $kk => $id) {
		...
		if($res){
			delPicFile($res[0]['icon'], "delAdv", "tieba");
		}
	}
