 ...
 * 管理旅游租车分类
 *
 * @version        $Id: travelrentcarType.php 2019-5-21 下午22:29:11 $
...
checkPurview("travelrentcarType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/travel";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "travelrentcarType.html";

$action = "travel_rentcartype";
...
//修改分类
	...
	if(!empty($results)){
		...
		if($results != "ok"){
			...
			// 更新缓存
			clearCache("travel_rentcartype", "key");
			clearCache("travel_rentcartype", $id);

			adminLog("修改旅游租车分类", $typename);
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/travel/travelrentcarType.js'
	);
