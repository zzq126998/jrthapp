 ...
 * 管理旅游攻略分类
 *
 * @version        $Id: travelstrategyType.php 2019-5-21 下午22:29:11 $
...
checkPurview("travelstrategyType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/travel";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "travelstrategyType.html";

$action = "travel_strategytype";
...
//修改分类
	...
	if(!empty($results)){
		...
		if($results != "ok"){
			...
			// 更新缓存
			clearCache("travel_strategytype", "key");
			clearCache("travel_strategytype", $id);

			adminLog("修改旅游攻略分类", $typename);
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/travel/travelstrategyType.js'
	);
