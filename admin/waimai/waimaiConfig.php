...
if ($type != "") {
    ...
    if ($type == "site") {
        ...
        $custom_firstOrderType = $firstOrderType;
    ...
    $customInc .= "\$serviceMoney = " . (int)$_POST['serviceMoney'] . ";\r\n";
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $huoniaoTag->assign('memberRefundswitchChecked', (int)$customMemberRefundswitch);

    //首单减免类型-单选
    $huoniaoTag->assign('firstOrderType', array(0 => '平台', 1 => '商铺'));
    $huoniaoTag->assign('custom_firstOrderType', $custom_firstOrderType);
