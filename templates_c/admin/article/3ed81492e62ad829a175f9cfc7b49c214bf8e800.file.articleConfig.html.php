<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-12 14:12:03
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\admin\templates\article\articleConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:13061629645d5103334f9572-61440804%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3ed81492e62ad829a175f9cfc7b49c214bf8e800' => 
    array (
      0 => 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\admin\\templates\\article\\articleConfig.html',
      1 => 1561028586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13061629645d5103334f9572-61440804',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5103335ef773_96291422',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5103335ef773_96291422')) {function content_5d5103335ef773_96291422($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\function.html_radios.php';
...
<style media="screen">
  ...
  #selfmedia_edit_limit {width:500px;float: left;}
  #selfmedia_edit_limit th, #selfmedia_edit_limit td {text-align: center;}
  #selfmedia_edit_limit td {min-width: 100px;}
  #selfmedia_edit_limit .txt {padding-top:8px;}
</style>
<?php echo '<script'; ?>
>
...
<div class="btn-group config-nav" data-toggle="buttons-radio">
  ...
  <button type="button" class="btn" data-type="rewrite">URL自定义</button>
  <button type="button" class="btn" data-type="audit">审核流程</button>
  <button type="button" class="btn" data-type="selfmedia">自媒体</button>
</div>

<div class="info-tips hide" id="infoTip"></div>

<form action="articleConfig.php" method="post" name="editform" id="editform" class="editform">
...
" />
  <div class="item">
    <dl class="clearfix">
      <dt><label for="channelname" class="sl">名称：</label><small><i>{</i><i>#$</i>article_channelName<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label class="sl">LOGO：</label><small><i>{</i><i>#$</i>article_logoUrl<i>#}</i></small></dt>
      <dd class="radio">
...
" class="imglist-hidden" id="sharePic">
    ...
    <dl class="clearfix">
      <dt><label class="sl">访问方式：</label><small><i>{</i><i>#$</i>article_channelDomain<i>#}</i></small></dt>
      <dd class="radio">
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="title" class="sl">seo标题：</label><small><i>{</i><i>#$</i>article_title<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="keywords" class="sl">关键字：</label><small><i>{</i><i>#$</i>article_keywords<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="description" class="sl">描述：</label><small><i>{</i><i>#$</i>article_description<i>#}</i></small></dt>
      <dd>
    ...
    <dl class="clearfix">
      <dt><label class="sl">咨询热线：</label><small><i>{</i><i>#$</i>article_hotline<i>#}</i></small></dt>
      <dd class="radio">
...
" placeholder="请输入频道咨询热线" />
    ...
    <dl class="clearfix">
      <dt><label for="submission" class="sl">投稿邮箱：</label><small><i>{</i><i>#$</i>article_submission<i>#}</i></small></dt>
      <dd class="radio">
        <input class="input-large" type="text" name="submission" id="submission" value="<?php echo $_smarty_tpl->tpl_vars['submission']->value;?>
" />
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="atlasMax">图集数量限制：</label></dt>
      <dd class="radio">
        <input class="input-mini" type="number" name="atlasMax" id="atlasMax" min="0" value="<?php echo $_smarty_tpl->tpl_vars['atlasMax']->value;?>
" /> 张
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>投稿审核：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"fabuCheck",'values'=>$_smarty_tpl->tpl_vars['fabuCheck']->value,'checked'=>$_smarty_tpl->tpl_vars['fabuCheckChecked']->value,'output'=>$_smarty_tpl->tpl_vars['fabuCheckNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>
    ...
    <dl class="clearfix">
      <dt><label>删除内容非站内链接：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"delLink",'values'=>$_smarty_tpl->tpl_vars['delLink']->value,'checked'=>$_smarty_tpl->tpl_vars['delLinkChecked']->value,'output'=>$_smarty_tpl->tpl_vars['delLinkNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>提取内容首图为缩图：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"autoLitpic",'values'=>$_smarty_tpl->tpl_vars['autoLitpic']->value,'checked'=>$_smarty_tpl->tpl_vars['autoLitpicChecked']->value,'output'=>$_smarty_tpl->tpl_vars['autoLitpicNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>打赏功能：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"rewardSwtich",'values'=>$_smarty_tpl->tpl_vars['rewardSwitch']->value,'checked'=>$_smarty_tpl->tpl_vars['rewardSwitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['rewardSwitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>
...
" />
    ...
    <table class="domain-rules">
      ...
      <tbody>
        <tr>
          <td>列表</td>
          <td>
            <select name="listRule" id="listRule">
              <option value="0"<?php if ($_smarty_tpl->tpl_vars['listRule']->value==0||$_smarty_tpl->tpl_vars['listRule']->value=='') {?> selected<?php }?>>默认【例：/list-1.html】</option>
              <option value="1"<?php if ($_smarty_tpl->tpl_vars['listRule']->value==1) {?> selected<?php }?>>分类全拼【例：/guonei/】</option>
              <option value="2"<?php if ($_smarty_tpl->tpl_vars['listRule']->value==2) {?> selected<?php }?>>分类首字母【例：/gn/】</option>
            </select>
          </td>
        </tr>
        <tr>
          <td>文章</td>
          <td>
            <select name="detailRule" id="detailRule">
              <option value="0"<?php if ($_smarty_tpl->tpl_vars['detailRule']->value==0||$_smarty_tpl->tpl_vars['detailRule']->value=='') {?> selected<?php }?>>默认【例：/detail-1.html】</option>
              <option value="1"<?php if ($_smarty_tpl->tpl_vars['detailRule']->value==1) {?> selected<?php }?>>不需要前缀【例：1.html】</option>
            </select>
          </td>
        </tr>
      </tbody>
  ...
  <div class="item hide">
    <dl class="clearfix">
      <dt><label>流程开关：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"auditswitch",'values'=>$_smarty_tpl->tpl_vars['auditswitch']->value,'checked'=>$_smarty_tpl->tpl_vars['auditswitchChecked']->value,'output'=>$_smarty_tpl->tpl_vars['auditswitchNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

        <span class="input-tips" style="display:inline-block;"><s></s>开启后，通过审核的信息将不能编辑</span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>权限控制：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>'auditAuth','values'=>$_smarty_tpl->tpl_vars['auditAuth']->value,'output'=>$_smarty_tpl->tpl_vars['auditAuthNames']->value,'selected'=>$_smarty_tpl->tpl_vars['auditAuthChecked']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

        <span class="input-tips" style="display:inline-block;"><s></s>除编辑人员外，其他人的权限</span></span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label>审批方式：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"auditType",'values'=>$_smarty_tpl->tpl_vars['auditType']->value,'checked'=>$_smarty_tpl->tpl_vars['auditTypeChecked']->value,'output'=>$_smarty_tpl->tpl_vars['auditTypeNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

        <span class="input-tips" style="display:inline-block;"><s></s>修改后不会影响已发布信息的审批方式</span></span>
      </dd>
    </dl>
  </div>
  <div class="item hide">
    ...
    <dl class="clearfix">
      ...
      <dd class="thumb clearfix listImgBox">
        <div class="uploadinp filePicker thumbtn<?php if ($_smarty_tpl->tpl_vars['selfmediaGrantImg']->value!='') {?> hide<?php }?>" id="filePicker_grant_img" data-type="advthumb"  data-count="1" data-size="<?php echo $_smarty_tpl->tpl_vars['thumbSize']->value;?>
" data-imglist=""><div></div><span></span></div>
        <?php if ($_smarty_tpl->tpl_vars['selfmediaGrantImg']->value!='') {?>
        <ul id="listSection_grant_img" class="listSection thumblist fn-clear" style="display:inline-block;"><li id="WU_FILE_simg_1"><a href='<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantImg']->value;?>
' target="_blank" title=""><img alt="" src="/include/attachment.php?f=<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantImg']->value;?>
" data-val="<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantImg']->value;?>
"/></a><a class="reupload li-rm" href="javascript:;"><?php echo $_smarty_tpl->tpl_vars['langData']->value['siteConfig'][19][176];?>
</a></li></ul>
        <?php } else { ?>
        <ul id="listSection_grant_img" class="listSection thumblist fn-clear"></ul>
        <?php }?>
        <input type="hidden" name="selfmediaGrantImg" value="<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantImg']->value;?>
" class="imglist-hidden" id="selfmediaGrantImg">
      </dd>
    </dl>
    <dl class="clearfix">
      <dt>授权书模板：</dt>
      <dd class="thumb clearfix listImgBox">
        <div class="uploadinp filePicker thumbtn<?php if ($_smarty_tpl->tpl_vars['selfmediaGrantTpl']->value!='') {?> hide<?php }?>" id="filePicker_grant_tpl" data-type="filenail"  data-count="1" data-size="<?php echo $_smarty_tpl->tpl_vars['softSize']->value;?>
" data-imglist=""><div></div><span></span></div>
        <?php if ($_smarty_tpl->tpl_vars['selfmediaGrantTpl']->value!='') {?>
        <ul id="listSection_grant_tpl" class="listSection thumblist fn-clear" style="display:inline-block;"><li id="WU_FILE_stpl_1"><a href="<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantTpl']->value;?>
" target="_blank" title="" class="enlarge" data-val="<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantTpl']->value;?>
"><span class="thumb-error">点击下载</span></a>&nbsp;&nbsp;<a class="li-rm" href="javascript:;">×</a></li></ul>
        <?php } else { ?>
        <ul id="listSection_grant_tpl" class="listSection thumblist fn-clear"></ul>
        <?php }?>
        <input type="hidden" name="selfmediaGrantTpl" value="<?php echo $_smarty_tpl->tpl_vars['selfmediaGrantTpl']->value;?>
" class="imglist-hidden" id="selfmediaGrantTpl">
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="selfmediaAgreement">入驻协议：</label></dt>
      <dd>
        <?php echo '<script'; ?>
 id="selfmediaAgreement" name="selfmediaAgreement" type="text/plain" style="width:85%;height:500px"><?php echo $_smarty_tpl->tpl_vars['selfmediaAgreement']->value;?>
<?php echo '</script'; ?>
>
      </dd>
    </dl>
