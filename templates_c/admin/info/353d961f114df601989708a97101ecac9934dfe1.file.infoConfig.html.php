<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-14 09:29:05
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\admin\templates\info\infoConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:2285780535d5363e1ba6149-22896923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '353d961f114df601989708a97101ecac9934dfe1' => 
    array (
      0 => 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\admin\\templates\\info\\infoConfig.html',
      1 => 1561028440,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2285780535d5363e1ba6149-22896923',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5363e1d1d201_67143301',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5363e1d1d201_67143301')) {function content_5d5363e1d1d201_67143301($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\function.html_radios.php';
...
<form action="infoConfig.php" method="post" name="editform" id="editform" class="editform">
...
" />
  <div class="item">
    <dl class="clearfix">
      <dt><label for="channelname" class="sl">名称：</label><small><i>{</i><i>#$</i>info_channelName<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label class="sl">LOGO：</label><small><i>{</i><i>#$</i>info_logoUrl<i>#}</i></small></dt>
      <dd class="radio">
...
" class="imglist-hidden" id="sharePic">
    ...
    <dl class="clearfix">
      <dt><label class="sl">访问方式：</label><small><i>{</i><i>#$</i>info_channelDomain<i>#}</i></small></dt>
      <dd class="radio">
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="title" class="sl">seo标题：</label><small><i>{</i><i>#$</i>info_title<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="keywords" class="sl">关键字：</label><small><i>{</i><i>#$</i>info_keywords<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="description" class="sl">描述：</label><small><i>{</i><i>#$</i>info_description<i>#}</i></small></dt>
      <dd>
    ...
    <dl class="clearfix">
      <dt><label class="sl">咨询热线：</label><small><i>{</i><i>#$</i>info_hotline<i>#}</i></small></dt>
      <dd class="radio">
...
../templates/info/<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['directory'];?>
...
&#10;版权所有：<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['copyright'];?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['adminPath']->value;?>
../templates/info/touch/<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['directory'];?>
/preview.jpg" /></a>
          <p>
            <span title="<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['tplname'];?>
"><?php echo $_smarty_tpl->tpl_vars['tplItem']->value['tplname'];?>
