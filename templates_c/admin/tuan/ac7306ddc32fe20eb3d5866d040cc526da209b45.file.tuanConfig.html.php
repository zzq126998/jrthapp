<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-13 16:27:12
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\admin\templates\tuan\tuanConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:1537805235d527460baed20-41303462%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac7306ddc32fe20eb3d5866d040cc526da209b45' => 
    array (
      0 => 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\admin\\templates\\tuan\\tuanConfig.html',
      1 => 1561028415,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1537805235d527460baed20-41303462',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d527460cc23f7_57130492',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d527460cc23f7_57130492')) {function content_5d527460cc23f7_57130492($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\function.html_radios.php';
...
<div class="btn-group config-nav" data-toggle="buttons-radio">
  ...
  <!-- <button type="button" class="btn" data-type="400">400电话验证</button> -->
  <!-- <button type="button" class="btn" data-type="subscribe">订阅功能配置</button> -->
...
<form action="tuanConfig.php" method="post" name="editform" id="editform" class="editform">
...
" placeholder="请输入频道咨询热线" />
    ...
    <dl class="clearfix">
      <dt><label for="recMoney">推荐返现金额：</label></dt>
      <dd>
        <input type="number" min="0" name="recMoney" id="recMoney" class="input-small" data-regex="\d*\.?\d+" value="<?php echo $_smarty_tpl->tpl_vars['recMoney']->value;?>
" />
        <span class="input-tips" style="display:inline-block;"><s></s>邀请好友返还现金，只能填写数字</span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="singelnum">单次购买数量限制：</label></dt>
      <dd>
        <input type="number" min="0" name="singelnum" id="singelnum" class="input-small" data-regex="[1-9]\d*" value="<?php echo $_smarty_tpl->tpl_vars['singelnum']->value;?>
" />
        <span class="input-tips" style="display:inline-block;"><s></s>单个商品一次最多可购买的数据，只能填写数字</span>
      </dd>
    </dl>
    <dl class="clearfix">
...
../templates/tuan/<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['directory'];?>
...
&#10;版权所有：<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['copyright'];?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['adminPath']->value;?>
../templates/tuan/touch/<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['directory'];?>
/preview.jpg" /></a>
          <p>
            <span title="<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['tplname'];?>
"><?php echo $_smarty_tpl->tpl_vars['tplItem']->value['tplname'];?>
...
" />
  ...
  <!-- <div class="item hide">
    <dl class="clearfix">
      <dt>操作说明：</dt>
      <dd>开通电话验证及消费团购券功能需具备什么样的条件？<br />1、在新联协同通信申请开通400号码（需提供企业营业执照复印件、法人身份证复印件）<br />2、在下面文本框中登记您的400电话号码</dd>
    </dl>
    <dl class="clearfix">
      <dt>第三方联系方式：</dt>
      <dd>联系QQ：120844472<br />联系电话：4000-366-365<br />网址：<a href="http://www.XL59.com" target="_blank">http://www.XL59.com</a></dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="Tel400">您的400电话号码：</label></dt>
      <dd>
        <input class="input-large" type="text" name="Tel400" id="Tel400" value="<?php echo $_smarty_tpl->tpl_vars['Tel400']->value;?>
" data-regex="[0-9]{10}" /><span class="help-inline">（如：4000366365）</span>
  ...
  <!-- <div class="item hide">
    <dl class="clearfix">
      <dt>开启订阅功能：</dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"subscribe",'values'=>$_smarty_tpl->tpl_vars['subscribe']->value,'checked'=>$_smarty_tpl->tpl_vars['subscribeChecked']->value,'output'=>$_smarty_tpl->tpl_vars['subscribeNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="subscribetime">每天发送时间：</label></dt>
      <dd>
        <input class="input-small" type="text" name="subscribetime" id="subscribetime" value="<?php echo $_smarty_tpl->tpl_vars['subscribetime']->value;?>
" data-regex="\d{1,2}:\d{1,2}" maxlength="5">
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="subscribetemp">邮件模板：</label></dt>
      <dd>
        <select name="subscribetemp" id="subscribetemp">
          <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['subscribetemp']->value,'selected'=>$_smarty_tpl->tpl_vars['subscribetempSelected']->value,'output'=>$_smarty_tpl->tpl_vars['subscribetemp']->value),$_smarty_tpl);?>

        </select>
        <span class="input-tips" style="display:inline-block;"><s></s>模板存放在<?php echo $_smarty_tpl->tpl_vars['HUONIAOROOT']->value;?>
/templates/edm/tuan下</span>
      </dd>
    </dl>
  </div> -->
  <div class="item hide">
