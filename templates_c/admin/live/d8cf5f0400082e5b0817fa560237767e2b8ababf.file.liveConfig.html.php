<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-12 14:34:19
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\admin\templates\live\liveConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:5212142125d51086b4a2076-28147966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8cf5f0400082e5b0817fa560237767e2b8ababf' => 
    array (
      0 => 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\admin\\templates\\live\\liveConfig.html',
      1 => 1561028413,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5212142125d51086b4a2076-28147966',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d51086b544289_87490011',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d51086b544289_87490011')) {function content_5d51086b544289_87490011($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_radios')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\function.html_radios.php';
...
<div class="btn-group config-nav" data-toggle="buttons-radio">
  ...
  <button type="button" class="btn" data-type="ftp">视频存储</button>
  <button type="button" class="btn" data-type="mark">水印设置</button>
  <!-- <button type="button" class="btn" data-type="rong">融云设置</button> -->
  <!--<button type="button" class="btn" data-type="rewrite">URL自定义</button>-->
</div>

<div class="info-tips hide" id="infoTip"></div>

<form action="liveConfig.php" method="post" name="editform" id="editform" class="editform">
...
" />
  ...
  <div class="item hide">
      ...
      <dl class="clearfix">
        ...
        <dd>
          <label><input type="radio" name="ftpType" value="1" checked="checked">阿里云OSS</label>
        </dd>
      </dl>
...
" data-regex=".*" />
      ...
      <div id="ftpType1" class="hide ftpType">
		<dl class="clearfix">
          ...
          <dd>
            <input class="input-large" type="text" name="OSSUrl" id="OSSUrl" value="<?php echo $_smarty_tpl->tpl_vars['server']->value;?>
" data-regex=".*" />
            <span class="input-tips" style="display:inline-block;"><s></s>&nbsp;完整的Http地址。如果没有绑定域名地址为：（Bucket name）.oss.aliyuncs.com</span>
          </dd>
        </dl>
        <dl class="clearfix">
          <dt><label for="OSSUrl">Endpoint：</label></dt>
          <dd>
            <input class="input-large" type="text" name="EndPoint" id="EndPoint" value="<?php echo $_smarty_tpl->tpl_vars['OSSUrl']->value;?>
" data-regex=".*" />
            <span class="input-tips" style="display:inline-block;"><s></s>&nbsp;如：oss-cn-hangzhou.aliyuncs.com</span>
          </dd>
        </dl>
        <dl class="clearfix">
...
" />
  ...
  <!-- <div class="item hide">
		<dl class="clearfix">
          <dt><label for="rongKeyID">Access Key ID：</label></dt>
          <dd>
            <input class="input-large" type="text" name="rongKeyID" id="rongKeyID" value="<?php echo $_smarty_tpl->tpl_vars['rongKeyID']->value;?>
" data-regex=".*">
            <span class="input-tips" style="display:inline-block;"><s></s>&nbsp;请填写生产环境App Key；<a href="http://www.rongcloud.cn" target="_blank">申请地址：http://www.rongcloud.cn</a></span>
          </dd>
        </dl>
        <dl class="clearfix">
          <dt><label for="rongKeySecret">Access Key Secret：</label></dt>
          <dd>
            <input class="input-large" type="text" name="rongKeySecret" id="rongKeySecret" value="<?php echo $_smarty_tpl->tpl_vars['rongKeySecret']->value;?>
" data-regex=".*">
            <span class="input-tips" style="display:inline-block;"><s></s>&nbsp;请填写生产环境App Secret</span>
          </dd>
        </dl>
  </div> -->
  <!-- <div class="item hide">
