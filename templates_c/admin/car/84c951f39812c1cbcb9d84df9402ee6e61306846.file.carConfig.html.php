<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-14 09:29:25
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\admin\templates\car\carConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:1025837405d5363f5009330-30465291%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '84c951f39812c1cbcb9d84df9402ee6e61306846' => 
    array (
      0 => 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\admin\\templates\\car\\carConfig.html',
      1 => 1561028577,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1025837405d5363f5009330-30465291',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'carCheckNames' => 0,
    'carTag' => 0,
    'securitysettingTag' => 0,
    'externalsettingTag' => 0,
    'internalsettingTag' => 0,
    'tplList' => 0,
    'articleTemplate' => 0,
    'tplItem' => 0,
    'cfg_staticVersion' => 0,
  ...
  'unifunc' => 'content_5d5363f50c8a11_97597801',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5363f50c8a11_97597801')) {function content_5d5363f50c8a11_97597801($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\modifier.replace.php';
...
<style media="screen">
  ...
  .priceWrap .btn {font-size:12px;color:#333;margin:2px 4px;}
  .priceWrap .btn i {margin-right: 5px;}

  .priceWrap .table th, .table td {vertical-align: middle;}

  #carTag,#internalsettingTag,#securitysettingTag,#externalsettingTag {width: 530px;height: 200px;}
  /*.priceWrap .table .group .del {cursor: default; background-image: none; opacity: .65; filter: alpha(opacity=65); -webkit-box-shadow: none; -moz-box-shadow: none; box-shadow: none;}*/
</style>
<?php echo '<script'; ?>
>
...
<form action="carConfig.php" method="post" name="editform" id="editform" class="editform">
...
" />
  <div class="item">
    <dl class="clearfix">
      <dt><label for="channelname" class="sl">名称：</label><small><i>{</i><i>#$</i>car_channelName<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label class="sl">LOGO：</label><small><i>{</i><i>#$</i>car_logoUrl<i>#}</i></small></dt>
      <dd class="radio">
...
" class="imglist-hidden" id="sharePic">
    ...
    <dl class="clearfix">
      <dt><label class="sl">访问方式：</label><small><i>{</i><i>#$</i>car_channelDomain<i>#}</i></small></dt>
      <dd class="radio">
...
" />
    ...
    <dl class="clearfix hide">
      <dt><label for="subwayCity">运营城市：</label></dt>
      <dd>
        <select name="subwayCity" id="subwayCity">
          <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['subwayList']->value,'selected'=>$_smarty_tpl->tpl_vars['subwayCity']->value),$_smarty_tpl);?>

        </select>
        <span class="input-tips" style="display:inline-block;"><s></s>请选择要运营的城市，此处的城市列表请在<a href="siteConfig/siteSubway.php" class="subway">公交地铁设置</a>中配置</span>
      </dd>
    </dl>
    <dl class="clearfix">
    ...
    <dl class="clearfix">
      <dt><label for="title" class="sl">seo标题：</label><small><i>{</i><i>#$</i>car_title<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="keywords" class="sl">关键字：</label><small><i>{</i><i>#$</i>car_keywords<i>#}</i></small></dt>
      <dd>
...
" />
    ...
    <dl class="clearfix">
      <dt><label for="description" class="sl">描述：</label><small><i>{</i><i>#$</i>car_description<i>#}</i></small></dt>
      <dd>
    ...
    <dl class="clearfix">
      <dt><label class="sl">咨询热线：</label><small><i>{</i><i>#$</i>car_hotline<i>#}</i></small></dt>
      <dd class="radio">
...
" placeholder="请输入频道咨询热线" />
    ...
    <dl class="clearfix">
      ...
      <dd class="radio">
        <div class="input-prepend input-append" style="margin: 0 10px 10px 0;">
          <span class="add-on">店铺配置</span>
          <input class="span1" id="store_atlasMax" name="store_atlasMax" type="text" value="<?php echo $_smarty_tpl->tpl_vars['store_atlasMax']->value;?>
">
          <span class="add-on">张</span>
        </div>
        <div class="input-prepend input-append" style="margin: 0 10px 10px 0;">
          <span class="add-on">发布二手车</span>
          <input class="span1" id="car_atlasMax" name="car_atlasMax" type="text" value="<?php echo $_smarty_tpl->tpl_vars['car_atlasMax']->value;?>
">
          <span class="add-on">张</span>
        </div>
      </dd>
    ...
    <dl class="clearfix">
      <dt><label>发布二手车审核：</label></dt>
      <dd class="radio">
        <?php echo smarty_function_html_radios(array('name'=>"carCheck",'values'=>$_smarty_tpl->tpl_vars['carCheckNum']->value,'checked'=>$_smarty_tpl->tpl_vars['carCheckChecked']->value,'output'=>$_smarty_tpl->tpl_vars['carCheckNames']->value,'separator'=>"&nbsp;&nbsp;"),$_smarty_tpl);?>

      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="carTag">服务范围：</label></dt>
      <dd>
        <textarea name="carTag" id="carTag" placeholder="服务范围"><?php echo $_smarty_tpl->tpl_vars['carTag']->value;?>
</textarea>
        <span class="input-tips" style="display:block;margin-top:10px;"><s></s>首次使用请点击下方“确认提交”按钮</span>
        <span class="input-tips" style="display:block;margin-top:10px;"><s></s>多个请用“|”分隔。如：车辆置换|价格评估|分期贷款</span>
        <span class="input-tips" style="display:block;margin-top:10px;"><s></s>如果需要增加或者修改标签内容，请上传标签图标到 "/static/images/car/" 目录下，图标为png类型，命名格式为：“b_sertag_ + 标签名称的全拼”</span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="securitysettingTag">安全配置：</label></dt>
      <dd>
        <textarea name="securitysettingTag" id="securitysettingTag" placeholder="安全配置"><?php echo $_smarty_tpl->tpl_vars['securitysettingTag']->value;?>
</textarea>
        <span class="input-tips" style="display:block;margin-top:10px;"><s></s>多个请用“1-|”分隔。如：1-主驾驶安全气囊|2-副驾驶安全气囊|3-前排侧气囊</span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="externalsettingTag">外部配置：</label></dt>
      <dd>
        <textarea name="externalsettingTag" id="externalsettingTag" placeholder="外部配置"><?php echo $_smarty_tpl->tpl_vars['externalsettingTag']->value;?>
</textarea>
        <span class="input-tips" style="display:block;margin-top:10px;"><s></s>多个请用“1-|”分隔。如：1-电动天窗|2-全景天窗|3-电动吸合门</span>
      </dd>
    </dl>
    <dl class="clearfix">
      <dt><label for="internalsettingTag">内部配置：</label></dt>
      <dd>
        <textarea name="internalsettingTag" id="internalsettingTag" placeholder="内部配置"><?php echo $_smarty_tpl->tpl_vars['internalsettingTag']->value;?>
</textarea>
        <span class="input-tips" style="display:block;margin-top:10px;"><s></s>多个请用“1-|”分隔。如：1-多功能方向盘|2-定速巡航|3-空调</span>
      </dd>
    </dl>
  </div>
...
../templates/car/<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['directory'];?>
...
&#10;版权所有：<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['copyright'];?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['adminPath']->value;?>
../templates/car/touch/<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['directory'];?>
/preview.jpg" /></a>
          <p>
            <span title="<?php echo $_smarty_tpl->tpl_vars['tplItem']->value['tplname'];?>
"><?php echo $_smarty_tpl->tpl_vars['tplItem']->value['tplname'];?>
...
<?php echo '<script'; ?>
 type="text/html" id="trTemp">
  <tr>
    <td class="td_name"><input class="input-small" type="text" name="trialCost[#id][name]" value="" placeholder=""></td>
    <td><div class="input-append"><input class="input-mini price" step="1" type="number" name="trialCost[#id][list][#k][time]" value=""><span class="add-on">月</span></div></td>
    <td><div class="input-append"><input class="input-mini price" step="0.01" type="number" name="trialCost[#id][list][#k][price]" value=""><span class="add-on">元</span></div></td>
    <td><div class="input-append"><input class="input-mini car" type="number" name="trialCost[#id][list][#k][car]" min="0" value=""><span class="add-on">个</span></div></td>
    <td><div class="input-append"><input class="input-mini refresh" type="number" name="trialCost[#id][list][#k][refresh]" min="0" value=""><span class="add-on">次</span></div></td>
    <td><div class="input-append"><input class="input-mini settop" type="number" name="trialCost[#id][list][#k][settop]" min="0" value=""><span class="add-on">天</span></div></td>
    <td class="td_del"><a href="javascript:;" class="btn del" title="删除"><i class="icon-trash"></i>删除价格</a></td>
    <td class="td_oper"><a href="javascript:;" class="btn add" title="新增"><i class="icon-plus"></i>新增价格</a><a href="javascript:;" class="btn delGroup" title="删除"><i class="icon-trash"></i>删除套餐</a></td>
  </tr>
<?php echo '</script'; ?>
>
