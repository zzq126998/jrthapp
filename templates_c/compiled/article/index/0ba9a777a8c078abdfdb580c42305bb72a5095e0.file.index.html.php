<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-13 10:04:23
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\templates\article\skin7\index.html" */ ?>
<?php /*%%SmartyHeaderCode:11832233065d5121fe737b00-57892215%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ba9a777a8c078abdfdb580c42305bb72a5095e0' => 
    array (
      0 => 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\templates\\article\\skin7\\index.html',
      1 => 1565661855,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11832233065d5121fe737b00-57892215',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5d5121fe854e16_07320131',
  'variables' => 
  array (
    'article_title' => 0,
    'article_keywords' => 0,
...
<?php if ($_valid && !is_callable('content_5d5121fe854e16_07320131')) {function content_5d5121fe854e16_07320131($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
...
<div class="contain">
    <div class="wrap">
        <div class="dad">
            <?php echo getMyAd(array('title'=>"新闻资讯_模板七_电脑端_首页_广告11一"),$_smarty_tpl);?>
            ...
            <div class="focusleft fn-left">
                <div class="adbox">
                    <div class=" slideBox" id="slideBox1">
                        ...
                        <div class="bd">
                            <ul>
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','mold'=>'0','pageSize'=>5,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','mold'=>'0','pageSize'=>5,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
                                ...
                                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','mold'=>'0','pageSize'=>5,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <div class="rad">
                    <?php echo getMyAd(array('title'=>"新闻资讯_模板七_电脑端_首页_广告二"),$_smarty_tpl);?>

                </div>

                <div class="rightlist">
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','flag'=>'r','pageSize'=>5,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','flag'=>'r','pageSize'=>5,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','flag'=>'r','pageSize'=>5,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
                ...
                <div class="itemlist">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','flag'=>'h','page'=>$_smarty_tpl->tpl_vars['i']->value,'pageSize'=>6,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','flag'=>'h','page'=>$_smarty_tpl->tpl_vars['i']->value,'pageSize'=>6,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','flag'=>'h','page'=>$_smarty_tpl->tpl_vars['i']->value,'pageSize'=>6,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">更多>></a></h3>
                    <ul class="medialist fn-clear">
                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'selfmedia','orderby'=>'time','pageSize'=>9,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'selfmedia','orderby'=>'time','pageSize'=>9,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"><?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
                        ...
                        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'selfmedia','orderby'=>'time','pageSize'=>9,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
"></a>
        ...
        <div class="dad">
            <?php echo getMyAd(array('title'=>"新闻资讯_模板七_电脑端_首页_广告三"),$_smarty_tpl);?>
...
" class="more">更多>></a>
            ...
            <div class="con fn-clear">
                <div class="fn-left vleft">
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','mold'=>2,'pageSize'=>1,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','mold'=>2,'pageSize'=>1,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','mold'=>2,'pageSize'=>1,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                </div>
                <ul class="vlist fn-clear">
                    <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable(0, null, 0);?>
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','mold'=>2,'pageSize'=>9,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','mold'=>2,'pageSize'=>9,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
                    ...
                    <div class="txt"><?php if ($_smarty_tpl->tpl_vars['list']->value['description']) {
...
echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['title']);
                    ...
                    <?php }?>
                    <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable($_smarty_tpl->tpl_vars['n']->value+1, null, 0);?>
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','mold'=>2,'pageSize'=>9,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <!--视频资讯 e-->
        <div class="dad">
            <?php echo getMyAd(array('title'=>"新闻资讯_模板七_电脑端_首页_广告四"),$_smarty_tpl);?>
...
$_tmp1=ob_get_clean();?><?php echo getMyAd(array('title'=>"新闻资讯_模板七_电脑端_首页_广告五_".$_tmp1),$_smarty_tpl);?>
...
" class="curr"><?php echo $_smarty_tpl->tpl_vars['type']->value['typename'];?>
                ...
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'type','type'=>$_smarty_tpl->tpl_vars['type']->value['id'],'return'=>'subtype')); $_block_repeat=true; echo article(array('action'=>'type','type'=>$_smarty_tpl->tpl_vars['type']->value['id'],'return'=>'subtype'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                <a href="<?php echo $_smarty_tpl->tpl_vars['subtype']->value['url'];?>
"><?php echo $_smarty_tpl->tpl_vars['subtype']->value['typename'];?>
</a>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'type','type'=>$_smarty_tpl->tpl_vars['type']->value['id'],'return'=>'subtype'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" class="more">更多>></a>
            ...
            <div class="con fn-clear">
                <div class="con-left fn-clear">
                    ...
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'pageSize'=>3,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'pageSize'=>3,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"></div>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'pageSize'=>3,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
                    <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable(0, null, 0);?>
                    <div class="itemlist">
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'page'=>$_smarty_tpl->tpl_vars['i']->value,'notid'=>$_smarty_tpl->tpl_vars['notid']->value,'pageSize'=>5,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'page'=>$_smarty_tpl->tpl_vars['i']->value,'notid'=>$_smarty_tpl->tpl_vars['notid']->value,'pageSize'=>5,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                        <a <?php if ($_smarty_tpl->tpl_vars['n']->value==0) {?>class="title"<?php }?> href="<?php echo $_smarty_tpl->tpl_vars['list']->value['url'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
</a>
                    <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable($_smarty_tpl->tpl_vars['n']->value+1, null, 0);?>
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'page'=>$_smarty_tpl->tpl_vars['i']->value,'notid'=>$_smarty_tpl->tpl_vars['notid']->value,'pageSize'=>5,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">更多>></a></h3>
                    <ul class="recomlist">
                        ...
                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'flag'=>'r','pageSize'=>6,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'flag'=>'r','pageSize'=>6,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
                        ...
                        <?php }?>
                        <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable($_smarty_tpl->tpl_vars['n']->value+1, null, 0);?>
                        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','typeid'=>$_smarty_tpl->tpl_vars['type']->value['id'],'flag'=>'r','pageSize'=>6,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <div class="dad">
            <?php echo getMyAd(array('title'=>"新闻资讯_模板七_电脑端_首页_广告六"),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
                            <li class="item fn-clear">
                                <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable(1, null, 0);?>
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('article', array('action'=>'alist','mold'=>1,'page'=>$_smarty_tpl->tpl_vars['i']->value,'pageSize'=>5,'return'=>'list')); $_block_repeat=true; echo article(array('action'=>'alist','mold'=>1,'page'=>$_smarty_tpl->tpl_vars['i']->value,'pageSize'=>5,'return'=>'list'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                                <?php if ($_smarty_tpl->tpl_vars['n']->value==1) {?>
                                <div class="picNewl fn-clear">
                                <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['n']->value<5) {?>
                                    <a class="item-c" href="<?php echo $_smarty_tpl->tpl_vars['list']->value['url'];?>
" target="_blank" title="<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['title']);?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['list']->value['litpic'];?>
" alt="<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['title']);?>
"> <div class="txt"><?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['title']);?>
</div>
                                        <div class="bg"></div></a>
                                    <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['n']->value==4||($_smarty_tpl->tpl_vars['pageInfo']->value['totalCount']<3&&$_smarty_tpl->tpl_vars['pageInfo']->value['totalCount']==$_smarty_tpl->tpl_vars['n']->value)) {?>
                                </div>
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['n']->value==5) {?>
                                <a class="item-c picNewr" href="<?php echo $_smarty_tpl->tpl_vars['list']->value['url'];?>
" target="_blank" title="<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['title']);?>
">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['list']->value['litpic'];?>
" alt="<?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['list']->value['title']);?>
">
                                ...
                                <?php }?>
                                <?php $_smarty_tpl->tpl_vars['n'] = new Smarty_variable($_smarty_tpl->tpl_vars['n']->value+1, null, 0);?>
                                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo article(array('action'=>'alist','mold'=>1,'page'=>$_smarty_tpl->tpl_vars['i']->value,'pageSize'=>5,'return'=>'list'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
