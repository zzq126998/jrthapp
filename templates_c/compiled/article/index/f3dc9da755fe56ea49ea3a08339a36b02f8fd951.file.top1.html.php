<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-12 16:23:26
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\templates\siteConfig\top1.html" */ ?>
<?php /*%%SmartyHeaderCode:159225665d5121fe89b334-84956423%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '159225665d5121fe89b334-84956423',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d5121fe8df919_76920146',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d5121fe8df919_76920146')) {function content_5d5121fe8df919_76920146($_smarty_tpl) {?><?php echo '<script'; ?>
...
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('siteConfig', array('action'=>'siteCity','return'=>'city','module'=>$_tmp2)); $_block_repeat=true; echo siteConfig(array('action'=>'siteCity','return'=>'city','module'=>$_tmp2), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
/static/images/changecity_curr.png" /></s></a></li>
					      <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo siteConfig(array('action'=>'siteCity','return'=>'city','module'=>$_tmp2), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp3=ob_get_clean();?><?php if (in_array("article",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp3)) {?><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'fabu','action'=>'article'),$_smarty_tpl);?>
...
<?php $_tmp4=ob_get_clean();?><?php if (in_array("info",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp4)) {?><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'fabu','action'=>'info'),$_smarty_tpl);?>
...
<?php $_tmp5=ob_get_clean();?><?php if (in_array("house",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp5)) {?><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'config','action'=>'house'),$_smarty_tpl);?>
...
<?php $_tmp6=ob_get_clean();?><?php if (in_array("huodong",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp6)) {?><a href="<?php echo getUrlPath(array('service'=>'huodong','template'=>'fabu'),$_smarty_tpl);?>
...
<?php $_tmp7=ob_get_clean();?><?php if (in_array("tieba",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp7)) {?><a href="<?php echo getUrlPath(array('service'=>'tieba','template'=>'index','param'=>'#publish'),$_smarty_tpl);?>
