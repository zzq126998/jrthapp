...
<?php /*%%SmartyHeaderCode:5675269715d510c12950589-50545551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5675269715d510c12950589-50545551',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d510c129989e7_22632233',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d510c129989e7_22632233')) {function content_5d510c129989e7_22632233($_smarty_tpl) {?><?php echo '<script'; ?>
...
<?php $_tmp994=ob_get_clean();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('siteConfig', array('action'=>'siteCity','return'=>'city','module'=>$_tmp994)); $_block_repeat=true; echo siteConfig(array('action'=>'siteCity','return'=>'city','module'=>$_tmp994), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
/static/images/changecity_curr.png" /></s></a></li>
					      <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo siteConfig(array('action'=>'siteCity','return'=>'city','module'=>$_tmp994), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp995=ob_get_clean();?><?php if (in_array("article",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp995)) {?><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'fabu','action'=>'article'),$_smarty_tpl);?>
...
<?php $_tmp996=ob_get_clean();?><?php if (in_array("info",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp996)) {?><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'fabu','action'=>'info'),$_smarty_tpl);?>
...
<?php $_tmp997=ob_get_clean();?><?php if (in_array("house",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp997)) {?><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'config','action'=>'house'),$_smarty_tpl);?>
...
<?php $_tmp998=ob_get_clean();?><?php if (in_array("huodong",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp998)) {?><a href="<?php echo getUrlPath(array('service'=>'huodong','template'=>'fabu'),$_smarty_tpl);?>
...
<?php $_tmp999=ob_get_clean();?><?php if (in_array("tieba",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp999)) {?><a href="<?php echo getUrlPath(array('service'=>'tieba','template'=>'index','param'=>'#publish'),$_smarty_tpl);?>
