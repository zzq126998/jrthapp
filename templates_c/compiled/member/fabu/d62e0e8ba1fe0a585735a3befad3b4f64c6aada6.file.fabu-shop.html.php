<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-08-16 11:06:39
         compiled from "D:\myphp_www\PHPTutorial\WWW\ziyuan\templates\member\company\fabu-shop.html" */ ?>
<?php /*%%SmartyHeaderCode:20540568945d54c57d56efe3-68265827%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20540568945d54c57d56efe3-68265827',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5d54c57d5dc620_68229637',
  'variables' => 
  array (
    'typeid' => 0,
    'do' => 0,
...
<?php if ($_valid && !is_callable('content_5d54c57d5dc620_68229637')) {function content_5d54c57d5dc620_68229637($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\modifier.replace.php';
...
">
	...
	<dl class="fn-clear" data-required="1">
		<dt><span>*</span>机身颜色：</dt>
		<dd>
			<label><input name="Fruit" type="radio" value="" />红色 </label>
			<label><input name="Fruit" type="radio" value="" />白色 </label>
			<label><input name="Fruit" type="radio" value="" />绿色 </label>
...
：</dt>-->
	...
	<!--</dl>-->
	<dl class="fn-clear" data-required="1">
		<dt><span>*</span>购机方式：</dt>
		<dd>
			<label><input name="Fruit" type="radio" value="" />分期购机 </label>
			<label><input name="Fruit" type="radio" value="" />全款购机 </label>
		</dd>
	</dl>
	<dl class="fn-clear" data-required="1">
		<dt><span>*</span>产品参数：</dt>
		<dd>
			<div onclick="checkair()">选择参数</div>
			<label><input name="paramsid" type="text" value="" id="getairid" /> </label>
		</dd>
	</dl>
	<!--<dl class="fn-clear" data-required="1">-->
...
layer/layer.js?v=<?php echo $_smarty_tpl->tpl_vars['cfg_staticVersion']->value;?>
"><?php echo '</script'; ?>
>
		<?php echo '<script'; ?>
>
            function checkair() {
                layer.open({
                    ...
                    fixed: false, //不固定
                    maxmin: true,
                    content: 'air_parameters.html?do=edit&id=2'
                });
            }
		<?php echo '</script'; ?>
>
