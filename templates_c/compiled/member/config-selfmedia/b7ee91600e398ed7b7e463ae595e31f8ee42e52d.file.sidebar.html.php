...
<?php /*%%SmartyHeaderCode:20543517455d5120773be500-38831078%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20543517455d5120773be500-38831078',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d512077456ad0_08743924',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d512077456ad0_08743924')) {function content_5d512077456ad0_08743924($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'D:\\myphp_www\\PHPTutorial\\WWW\\ziyuan\\include\\tpl\\plugins\\modifier.replace.php';
?><!-- 侧栏 s -->
<div class="sidebar">
	<dl>
...
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo verifyModuleAuth(array('module'=>'tieba','type'=>'userCenter'),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php if (((in_array("article",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&$_tmp6)||(in_array("tieba",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&$_tmp7))&&in_array('reward',$_smarty_tpl->tpl_vars['cfg_ucenterLinks']->value)) {?>
...
<s><i></i></s></dt>
		...
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('siteConfig', array('action'=>"siteModule",'return'=>"module")); $_block_repeat=true; echo siteConfig(array('action'=>"siteModule",'return'=>"module"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
			...
			<?php ob_start();?><?php echo verifyModuleAuth(array('module'=>'article','type'=>'userCenter'),$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='article'&&$_tmp8) {?>
			<dd>
...
<?php $_tmp9=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='info'&&$_tmp9) {?>
			<dd>
...
<?php $_tmp10=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='house'&&$_tmp10) {?>
			<dd>
...
<?php $_tmp11=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='job'&&$_tmp11) {?>
			<dd>
...
<?php $_tmp13=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='dating'&&$_tmp13) {?>
			<dd>
...
<?php $_tmp14=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='huodong'&&$_tmp14) {?>
			<dd>
...
<?php $_tmp15=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='vote'&&$_tmp15) {?>
			<dd>
...
<?php $_tmp16=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='live'&&$_tmp16) {?>
			<dd>
...
<?php $_tmp17=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='car'&&$_tmp17) {?>
			<dd>
