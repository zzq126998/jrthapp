...
<?php $_tmp16=ob_get_clean();?><?php if (in_array("article",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp16)) {?>
					<dd>
...
<?php $_tmp17=ob_get_clean();?><?php if (in_array("info",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp17)) {?><dd><a href="<?php echo getUrlPath(array('service'=>'member','type'=>'user','template'=>'fabu','action'=>'info'),$_smarty_tpl);?>
...
<?php $_tmp18=ob_get_clean();?><?php if (in_array("house",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp18)) {?>
					<dd>
...
<?php $_tmp19=ob_get_clean();?><?php if (in_array("tieba",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp19)) {?>
...
<?php $_tmp20=ob_get_clean();?><?php if (in_array("huodong",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&(!$_smarty_tpl->tpl_vars['userinfo']->value||$_tmp20)) {?>
