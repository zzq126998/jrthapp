...
<?php $_tmp21=ob_get_clean();?><?php ob_start();?><?php echo verifyModuleAuth(array('module'=>'tieba','type'=>'userCenter'),$_smarty_tpl);?>
<?php $_tmp22=ob_get_clean();?><?php if (((in_array("article",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&$_tmp21)||(in_array("tieba",$_smarty_tpl->tpl_vars['installModuleArr']->value)&&$_tmp22))&&in_array('reward',$_smarty_tpl->tpl_vars['cfg_ucenterLinks']->value)) {?>
...
<s><i></i></s></dt>
		...
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('siteConfig', array('action'=>"siteModule",'return'=>"module")); $_block_repeat=true; echo siteConfig(array('action'=>"siteModule",'return'=>"module"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
			...
			<?php ob_start();?><?php echo verifyModuleAuth(array('module'=>'article','type'=>'userCenter'),$_smarty_tpl);?>
<?php $_tmp23=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='article'&&$_tmp23) {?>
			<dd>
...
<?php $_tmp24=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='info'&&$_tmp24) {?>
			<dd>
...
<?php $_tmp25=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='house'&&$_tmp25) {?>
			<dd>
...
<?php $_tmp26=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='job'&&$_tmp26) {?>
			<dd>
...
<?php $_tmp27=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='tieba'&&$_tmp27) {?>
			<dd>
...
<?php $_tmp28=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='dating'&&$_tmp28) {?>
			<dd>
...
<?php $_tmp29=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='huodong'&&$_tmp29) {?>
			<dd>
...
<?php $_tmp30=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='vote'&&$_tmp30) {?>
			<dd>
...
<?php $_tmp31=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='live'&&$_tmp31) {?>
			<dd>
...
<?php $_tmp32=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['module']->value['code']=='car'&&$_tmp32) {?>
			<dd>
