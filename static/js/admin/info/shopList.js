        ...
        init = {
            ...
            ,del: function(){
                ...
                if(checked.length < 1){
                    ...
                    huoniao.operaJson("shopList.php?dopost=del", "id="+id, function(data){
                        if(data.state == 100){
            ...
            ,updateState: function(type){
                ...
                if(checked.length < 1){
                    ...
                    huoniao.operaJson("shopList.php?dopost=updateState", "id="+id+"&state="+state, function(data){
                        if(data.state == 100){
                            huoniao.showTip("success", data.info, "auto");
                            setTimeout(function() {
                                getList();
...
function getList(){
    ...
    huoniao.operaJson("shopList.php?dopost=getList", data.join("&"), function(val){
