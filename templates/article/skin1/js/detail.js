$(function(){
	...
	function getCommentList(list){
		...
		for(var i = 0; i < list.length; i++){
			...
			html.push(' <a target="_blank" href="'+ masterDomain +'/user/'+list[i].userinfo['userid']+'"> <img onerror="javascript:this.src=\''+staticPath+'images/noPhoto_40.jpg\';" data-uid="'+list[i].userinfo['userid']+'" src="'+photo+'" alt="'+list[i].userinfo['nickname']+'"></a>');
			html.push('  <div class="c-body">');
			html.push('    <div class="c-header">');
			html.push('      <a target="_blank" href="'+ masterDomain +'/user/'+list[i].userinfo['userid']+'" data-id="'+list[i].userinfo['userid']+'">'+list[i].userinfo['nickname']+'</a>');
			html.push('      <span> </span>');
			html.push('    </div>');
		...
		$.ajax({
			...
			success: function (data) {
				...
				if(data && data.state == 100){
					...
					list.push(' <a target="_blank" href="'+ masterDomain +'/user/'+list[i].userinfo['userid']+'">  <img onerror="javascript:this.src=\''+staticPath+'images/noPhoto_40.jpg\';" data-uid="'+info.userinfo['userid']+'" src="'+info.userinfo['photo']+'" alt="'+info.userinfo['nickname']+'"></a>');
					list.push('  <div class="c-body">');
					list.push('    <div class="c-header">');
					list.push('      <a target="_blank" href="'+ masterDomain +'/user/'+list[i].userinfo['userid']+'" data-id="'+info.userinfo['userid']+'">'+info.userinfo['nickname']+'</a>');
