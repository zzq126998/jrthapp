$(function(){
    ...
    $('.wcmt_send, .submit_top').click(function(){
		...
		$.ajax({
			url: "/include/ajax.php?service=article&action=sendCommon&aid="+newsid+"&id="+comdetailid,
    ...
    function getComment(tr){
        ...
        $.ajax({
          url: '/include/ajax.php?service=article&action=getCommonList&fid='+comdetailid+'&page='+page+'&pageSize='+pageSize,
          type: 'get',
          dataType: 'jsonp',
          success: function(data){
              if(data && data.state == 100){
