$(function () {
    ...
    function getList() {
        ...
        var url = "/include/ajax.php?service=house&action=spList";
                ...
                if (data.state == 100) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        if (d.type == 0 || d.type == 2) {
                            html.push('<span class="lpprice">' + (d.price > 0 ? '<b>' + d.price + '</b>'+echoCurrency('short')+'/月' :
                                '<b>价格面议</b>') + '</span>');
                        } else {
                        ...
                        html.push('</div>');
                        if (d.type == 0) {
                            html.push('<div class="sp_r fn-right">' + (d.price / d.area).toFixed(1) + ' '+echoCurrency('short')+'/平米·月</div>');
                        } else if (d.type == 1) {
