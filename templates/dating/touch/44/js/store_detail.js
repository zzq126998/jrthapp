$(function(){
  ...
  function getList(){
    ...
    showMsg.loading();
    $.ajax({
      url: masterDomain + '/include/ajax.php?service=dating&action=memberList&store='+storeUid+'&page='+page+'&pageSize='+pageSize,
      type: 'get',
      dataType: 'jsonp',
      success: function(data){
        if(data && data.state == 100){
          ...
          for(var i = 0; i < length; i++){
            ...
            html.push('    <div class="img"><a href="'+d.url+'"><img src="'+d.photo+'" alt="">'+(d.level ? '<i class="user_video"></i>' : '')+'</a></div>');
