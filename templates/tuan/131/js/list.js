$(function(){
    ...
    function getTuanData(type){
        ...
        $.ajax({
            url: "/include/ajax.php?service=tuan&action=tList&iscity=1&pin=2&pageSize="+pageSize+"&typeid="+typeid+"&addrid="+addrid+"&business="+business+"&subway="+subway+"&station="+station+"&item="+item.join("$$")+"&orderby="+orderby+"&flag="+flag.join(",")+"&title="+keywords+"&page="+atpage,
            type: "GET",
            dataType: "jsonp",
