$(function(){
	// banna轮播图
	new Swiper('#slider', {pagination: '#slider .pagination', slideClass: 'slideshow-item', paginationClickable: true, loop: true, autoplay:2000, autoplayDisableOnInteraction : false});
	new Swiper('#fitment-pic', {slideClass: 'swiper-slide', paginationClickable: true, loop: true, autoplay:2000, autoplayDisableOnInteraction : false});
