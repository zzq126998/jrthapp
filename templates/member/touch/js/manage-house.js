    		...
    		if(data && data.state != 200){
    			if(data.state == 101){
                    ...
                    html.push('<a href="'+url+'">');
    							...
    							html.push('<dd class="item-area"><em>'+addr+'</em><em>'+bno+'/'+floor+'层</em><span class="price fn-right">'+price+'万'+echoCurrency('short')+'</span></dd>');
                  ...
                  html.push('<div class="house-box" data-id="'+id+'">');
                    ...
                    html.push('<a href="'+url+'">');
    							...
    							html.push('<dl>');
    							html.push('<dt>'+title+'</dt>');
    							html.push('<dd class="item-area"><em>'+addr+'</em><em>'+bno+'/'+floor+'层</em><em>'+rentype+'</em><span class="price fn-right">'+price+'万'+echoCurrency('short')+'</span></dd>');
    							html.push('<dd class="item-type-1"><em>'+community+'</em><em>建面:'+area+'㎡</em><em>'+room+'</em><em>'+protype+'</em></dd>');
    							html.push('<dd class="item-type-2">');
                  if(list[i]['state'] == 1){
                    if(isbid == 1){
                  ...
                  var p = lei == 0 ? echoCurrency('short')+"/m²•月" : "万"+echoCurrency('short');
                  ...
                  var p = lei == 0 ? echoCurrency('short')+"/月" : "万"+echoCurrency('short');
