$(function () {
    ...
    $('.sure_btn').click(function () {
        if(!$('#title_text').val()){
            ...
            for (var i=0;i<datas.length;i++){
                var list =`
                 <li id="`+vidoid+`">
                    <div class="img-box"><img src="`+datas[i].img+`" alt=""></div>
                    <i class="play_btn"></i>
                    <span class="del_btn">+</span>
                    <div class="title">`+datas[i].tit+`</div>
                </li>
                `;
            }
    ...
    $('.fabu_btn .btn').click(function () {
        if(!$('#comname').val()){
            ...
            showErr(''+langData['marry'][4][26]+'');//请输入主持人介绍！
        }
    });
