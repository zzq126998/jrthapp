		...
		init: function(){
			...
			if(cartHistory && foodIds.length > 0){
				...
				for (var i = 0; i < cartHistory.length; i++) {
					...
					list.push('<div class="cart-list fn-clear" data-id="'+cartHistory[i].id+'" data-name="'+cartHistory[i].title+'" data-pic="'+cartHistory[i].pic+'" data-unit="'+langData['siteConfig'][21][17]+'" data-price="'+cartHistory[i].price+'" data-dabao="0" data-ntitle="'+cartHistory[i].ntitle+'" data-nprice="'+cartHistory[i].nprice+'">');
