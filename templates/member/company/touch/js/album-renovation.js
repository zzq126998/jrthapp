$(function(){
  ...
  function getList(is){
    ...
    $.ajax({
      url: masterDomain+"/include/ajax.php?service=renovation&action=rcase&u=1&orderby=1&page="+atpage+"&pageSize="+pageSize,
      type: "GET",
      dataType: "jsonp",
      success: function (data) {
          ...
          if(data.state == 101){
            ...
            if(list.length > 0){
              ...
              for(var i = 0; i < list.length; i++){
                ...
                html.push('<p class="post">'+langData['siteConfig'][19][394]+'：'+click+'</em></p>');
