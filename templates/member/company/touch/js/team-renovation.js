          ...
          if(data.state == 101){
            ...
            if(list.length > 0){
              ...
              for(var i = 0; i < list.length; i++){
                ...
                html.push('<div class="item-img"><a href="'+url+'"><img src="'+photo+'" /></a></div>');
                html.push('<div class="item-txt">');
                html.push('<a href="'+url+'">');
                html.push('<p class="name">'+name+'</em></p>');
                html.push('<p class="post">'+post+'</em></p>');
                html.push('<p class="idea">'+idea+'</p>');
                html.push('</a>');
