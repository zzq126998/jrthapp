$(function(){
  ...
  $(".mapresults").delegate("li", "click", function(){
    ...
    // });
    //年月日
    $('#operPeriodb, #founded, #inspection').scroller(
      $.extend({preset: 'date', dateFormat: 'yy-mm-dd'})
    );
    $('#operPeriode').scroller(
      $.extend({preset: 'date', dateFormat: 'yy-mm-dd', endYear: 2099})
    );
...
$(function(){
  ...
  if (ua.match(/MicroMessenger/i) == "micromessenger") {
    setInterval(function(){
      $('#fileList1 .thumbnail').length && !$('#fileList1 .thumbnail .face').length && uploaderSuccess();
    }, 1000)
  }
})
